...
@Component({
  selector: 'app-book-usdt-xmr',
  templateUrl: './book-usdt-xmr.component.html',
  styleUrls: ['./book-usdt-xmr.component.css']
})
export class BookUsdtXmrComponent implements OnInit, AfterViewInit {
