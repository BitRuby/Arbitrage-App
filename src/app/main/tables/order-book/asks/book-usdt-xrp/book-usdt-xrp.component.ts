...
@Component({
  selector: 'app-book-usdt-xrp',
  templateUrl: './book-usdt-xrp.component.html',
  styleUrls: ['./book-usdt-xrp.component.css']
})
export class BookUsdtXrpComponent implements OnInit, AfterViewInit {
