...
@Component({
  selector: 'app-book-usdt-btc',
  templateUrl: './book-usdt-btc.component.html',
  styleUrls: ['./book-usdt-btc.component.css']
})
export class BookUsdtBtcComponent implements OnInit, AfterViewInit {
