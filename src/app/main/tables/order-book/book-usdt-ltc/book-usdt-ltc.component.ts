...
@Component({
  selector: 'app-book-usdt-ltc',
  templateUrl: './book-usdt-ltc.component.html',
  styleUrls: ['./book-usdt-ltc.component.css']
})
export class BookUsdtLtcComponent implements OnInit, AfterViewInit {
