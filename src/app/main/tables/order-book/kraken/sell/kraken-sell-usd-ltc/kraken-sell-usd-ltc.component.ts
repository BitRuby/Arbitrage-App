...
@Component({
  selector: 'app-kraken-sell-usd-ltc',
  templateUrl: './kraken-sell-usd-ltc.component.html',
  styleUrls: ['./kraken-sell-usd-ltc.component.css']
})
export class KrakenSellUsdLtcComponent implements OnInit {
  ...
  private getTransfers(): void {
    ...
    this.orderBookService.getOrderBookKraken(currency1, currency2)
      .subscribe(orders => {
        ...
        this.dataSource = orders.result.XLTCZUSD['asks'];
