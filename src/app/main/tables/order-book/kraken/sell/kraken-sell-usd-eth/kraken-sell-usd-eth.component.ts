...
@Component({
  selector: 'app-kraken-sell-usd-eth',
  templateUrl: './kraken-sell-usd-eth.component.html',
  styleUrls: ['./kraken-sell-usd-eth.component.css']
})
export class KrakenSellUsdEthComponent implements OnInit {
  ...
  private getTransfers(): void {
    ...
    this.orderBookService.getOrderBookKraken(currency1, currency2)
      .subscribe(orders => {
        ...
        this.dataSource = orders.result.XETHZUSD['asks'];
