...
@Component({
  selector: 'app-kraken-sell-usd-usdt',
  templateUrl: './kraken-sell-usd-usdt.component.html',
  styleUrls: ['./kraken-sell-usd-usdt.component.css']
})
export class KrakenSellUsdUsdtComponent implements OnInit {
  ...
  private getTransfers(): void {
    ...
    this.orderBookService.getOrderBookKraken(currency1, currency2)
      .subscribe(orders => {
        ...
        this.dataSource = orders.result.USDTZUSD['asks'];
