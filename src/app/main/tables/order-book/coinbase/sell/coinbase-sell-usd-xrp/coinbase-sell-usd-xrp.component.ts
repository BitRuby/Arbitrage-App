...
@Component({
  selector: 'app-coinbase-sell-usd-xrp',
  templateUrl: './coinbase-sell-usd-xrp.component.html',
  styleUrls: ['./coinbase-sell-usd-xrp.component.css']
})
export class CoinbaseSellUsdXrpComponent implements OnInit {
  dataSource;
