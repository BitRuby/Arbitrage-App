...
@Component({
  selector: 'app-coinbase-sell-usd-eth',
  templateUrl: './coinbase-sell-usd-eth.component.html',
  styleUrls: ['./coinbase-sell-usd-eth.component.css']
})
export class CoinbaseSellUsdEthComponent implements OnInit {
  dataSource;
