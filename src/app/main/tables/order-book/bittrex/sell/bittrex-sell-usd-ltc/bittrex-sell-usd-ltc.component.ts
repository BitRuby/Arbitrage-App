...
@Component({
  selector: 'app-bittrex-sell-usd-ltc',
  templateUrl: './bittrex-sell-usd-ltc.component.html',
  styleUrls: ['./bittrex-sell-usd-ltc.component.css']
})
export class BittrexSellUsdLtcComponent implements OnInit, AfterViewInit {
