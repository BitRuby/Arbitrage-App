...
@Component({
  selector: 'app-bitfinex-buy-usd-eth',
  templateUrl: './bitfinex-buy-usd-eth.component.html',
  styleUrls: ['./bitfinex-buy-usd-eth.component.css']
})
export class BitfinexBuyUsdEthComponent implements OnInit, AfterViewInit {
