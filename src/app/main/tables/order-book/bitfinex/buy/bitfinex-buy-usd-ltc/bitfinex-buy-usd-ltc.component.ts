...
@Component({
  selector: 'app-bitfinex-buy-usd-ltc',
  templateUrl: './bitfinex-buy-usd-ltc.component.html',
  styleUrls: ['./bitfinex-buy-usd-ltc.component.css']
})
export class BitfinexBuyUsdLtcComponent implements OnInit, AfterViewInit {
